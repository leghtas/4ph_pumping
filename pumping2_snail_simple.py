...
#    ax00[1,1].legend()
    ...
    ax2[0,0].plot(phiVec/2/pi, Xi_a2s/1e6, '.', label= '$a^2b^{+}$')
    
    dXi_a2s=np.diff(Xi_a2s)/(phiVec[1]-phiVec[0])*pi/10
