...
import circuit
import circuit_find_capa as cp2s
...
w, Z = [5.8e9*2*np.pi, 120]
Cc = 252e-15

LJ = 3000e-12
dLJ = 500e-12 #linear part for sna to be adjusted

wJ = 16.9*2*np.pi*1e9 #GHz without big_capa HFSS
...
_, _, EJ = circuit.get_E_from_w(1, 1, LJ+dLJ)

#EJ, LJ, I0 = circuit.convert_EJ_LJ_I0(I0=I0)


c = cp2s.CircuitPump2Snail(w, Z, Cc, EJ, CJ, wJ)
...
#    ax[0,2].plot(phiVec/2/pi, Xi4[0,:]/1e6)
#    ax[1,2].plot(phiVec/2/pi, Xi2[1,:]/1e9)
