...
import circuit
import circuit_basic_trm as cp2s
...
if 1==1:
    ...
    for kk, xx in enumerate(phiVec):
        _res  = c.get_freqs_kerrs(return_components=True, phi_ext_0=xx)
    ...
    print('\nf0 = %.3f GHz'%(Xi2[0,:][0]/1e9))
    print('Kerr = %.3f MHz'%(2*Xi4[0,:][0]/1e6))
