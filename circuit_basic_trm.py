...
class CircuitPump2Snail(c.Circuit):
    ...
    def __init__(self, w, EJ, printParams=True):
        ...
        self.U_str = '-EJ/hbar*cos(p)+0*phi_ext_0'
    ...
    def get_freqs_kerrs(self, particulars=None, return_components=False, **kwargs): #particulars should be list of tuple
        ...
        popt2 = np.array([Hess2_r[0, 0]/2])
        popt3 = np.array([Hess3_r[0, 0, 0]/6])
        popt4 = np.array([Hess4_r[0, 0, 0, 0]/24])
